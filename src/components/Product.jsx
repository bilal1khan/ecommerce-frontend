...
const Product = () => {
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      try {
        const response = await axios.get(
          `https://ecomxpressbackend.azurewebsites.net/api/product/${id}`
        );
    ...
    const fetchImage = async () => {
      const response = await axios.get(
        `https://ecomxpressbackend.azurewebsites.net/api/product/${id}/image`,
        { responseType: "blob" }
      );
  ...
  const deleteProduct = async () => {
    try {
      await axios.delete(`https://ecomxpressbackend.azurewebsites.net/api/product/${id}`);
      removeFromCart(id);
